  ...
  return (
    <header style={{
      ...
      <div className="container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '80px' }}>
        {/* Logo */}
        <a href="/" style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', textDecoration: 'none', color: 'var(--text-primary)' }}>
          <img src={logo} alt="Naqsha" style={{ height: '45px', borderRadius: '8px' }} />
          <span style={{ fontSize: '1.5rem', fontWeight: 'bold', color: 'var(--primary)', letterSpacing: '-0.5px' }}>Naqsha</span>
        </a>
        ...
        <div className="mobile-actions" style={{ display: 'none', alignItems: 'center' }}>
          <style>
            {`
                  @media (max-width: 768px) {
        ...
        <div className="desktop-actions" style={{ display: 'flex', gap: '1.5rem', alignItems: 'center' }}>
          ...
          {user ? (
            ...
            <Link to="/login" style={{ textDecoration: 'none' }}>
              <button style={{ background: 'none', border: 'none', color: 'var(--text-primary)', cursor: 'pointer', display: 'flex', alignItems: 'center' }}>
                <User size={24} />
                <span style={{ marginLeft: '8px', fontWeight: '500' }}>{t('signIn')}</span>
              </button>
            </Link>
          )}
