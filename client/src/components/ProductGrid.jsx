...
const ProductGrid = ({ searchQuery }) => {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        console.log("Backend unreachable/slow, serving mock data");
        ...
        setProducts([
          ...
          {
            id: 4,
            name: "Gaming Laptop Naqsha-Series",
            price: 65000,
            rating: 4.6,
  ...
  return (
    <section className="container page-enter" style={{ paddingBottom: '4rem' }}>
      <h2 style={{ fontSize: '2rem', marginBottom: '2rem' }}>{t('trendingNow')}</h2>
